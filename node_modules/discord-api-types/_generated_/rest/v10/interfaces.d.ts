...
export interface RoutesDeclarations {
     ...
     */
    channelVoiceStatus(channelId: Snowflake): `/channels/${string}/voice-status`;
    /**
     * Route for:
     ...
     */
    inviteTargetUsers(code: string): `/invites/${string}/target-users`;
    /**
     * Route for:
     * - GET `/invites/{invite.code}/target-users/job-status`
     */
    inviteTargetUsersJobStatus(code: string): `/invites/${string}/target-users/job-status`;
    /**
     * Route for:
